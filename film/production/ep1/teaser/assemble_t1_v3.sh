...
FC="$FC[18:a]aformat=sample_fmts=fltp:sample_rates=48000:channel_layouts=stereo,adelay=55440|55440[n5];"
...
$FF -hide_banner -loglevel error $IN -i w0.wav -i w1.wav -i w2.wav -i w3.wav -i w4.wav -i ../../sync/s11.mp3 \
 -filter_complex "$FC" -map "[vout]" -map "[aout]" \
 -c:v libx264 -b:v 2600k -maxrate 3100k -bufsize 5200k -preset medium -t 65 -pix_fmt yuv420p -r 24 \
 -c:a aac -b:a 192k -ar 48000 -movflags +faststart QDAY_EP1_teaser_v3.mp4 -y
